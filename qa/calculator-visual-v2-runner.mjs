...
const replacements = [
  [
    ...
    "assert.match(contract.decor[0].bg, /overlay-top-left-hires\\.webp/, `${browserName}: approved top-left composition changed`);",
  ],
  [
    "assert.match(contract.decor[1].bg, /ner-character-bottom-left\\.png/, `${browserName}: bottom-left master changed`);",
    "assert.match(contract.decor[1].bg, /overlay-bottom-left-hires\\.webp/, `${browserName}: approved bottom-left composition changed`);",
  ],
  [
    "assert.match(contract.decor[2].bg, /ner-character-right\\.png/, `${browserName}: right master changed`);",
    "assert.match(contract.decor[2].bg, /overlay-right-hires\\.webp/, `${browserName}: approved right composition changed`);",
  ],
  [
